...
export class ModuserComponent implements OnInit {
  ...
  async formInit() {
    ...
    this.formulario = this.fb.group({
      ...
      ap: [this.persona[0].ap, [Validators.required, Validators.maxLength(35), Validators.pattern(this.regex)]],
      am: [this.persona[0].am, [Validators.required, Validators.maxLength(35), Validators.pattern(this.regex)]],
